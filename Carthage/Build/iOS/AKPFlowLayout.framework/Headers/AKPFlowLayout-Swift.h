...
SWIFT_CLASS("_TtC13AKPFlowLayout13AKPFlowLayout")
@interface AKPFlowLayout : UICollectionViewFlowLayout
@property (nonatomic) CGFloat firsSectionMaximumStretchHeight;
...
/// \returns  <code>true
/// </code>, unless running on iOS9 with <code>sectionHeadersPinToVisibleBounds
/// </code> set to <code>true
/// </code>
- (BOOL)shouldInvalidateLayoutForBoundsChange:(CGRect)newBounds;

/// Custom invalidation context
- (UICollectionViewLayoutInvalidationContext * _Nonnull)invalidationContextForBoundsChange:(CGRect)newBounds;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
@end


@interface AKPFlowLayout (SWIFT_EXTENSION(AKPFlowLayout))
@end


SWIFT_CLASS("_TtC13AKPFlowLayout23AKPFlowLayoutAttributes")
@interface AKPFlowLayoutAttributes : UICollectionViewLayoutAttributes
...
@interface AKPFlowLayoutAttributes (SWIFT_EXTENSION(AKPFlowLayout))
@end
